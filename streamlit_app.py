...
btn_click = st.button("About")
if btn_click == True:
    st.text("Here we are on the page to predict the diamond price ,Kindly give the input as per the requirement and get the price of yours diamond")

scaler = load(open(r'C:\Users\SNEGHAL\.streamlit\model\models/standard_scaler.pkl', 'rb'))
# encoder=load(open('models/onehot_encoder.pkl','rb'))

rf_model = load(open(r'C:/Users/SNEGHAL/.streamlit/model/models/randomforestregression.pkl', 'rb'))
